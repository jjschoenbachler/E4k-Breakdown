...
.method constructor <init>(Lcom/ironsource/sdk/controller/WebController$NativeAPI;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/ironsource/sdk/controller/WebController$NativeAPI$14;->val$demandSourceId:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v2, p0, Lcom/ironsource/sdk/controller/WebController$NativeAPI$14;->val$demandSourceId:Ljava/lang/String;

    const/4 v3, 0x0

    invoke-interface {v0, v1, v2, v3}, Lcom/ironsource/sdk/listeners/internals/DSInterstitialListener;->onAdProductInitSuccess(Lcom/ironsource/sdk/data/ISNEnums$ProductType;Ljava/lang/String;Lcom/ironsource/sdk/data/AdUnitsReady;)V
