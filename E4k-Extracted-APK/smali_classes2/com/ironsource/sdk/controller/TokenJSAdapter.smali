...
.field private mControllerGlobalDatarWriter:Lcom/ironsource/sdk/service/NetworkGlobalDataWriter;

.field private mTokenProvider:Lcom/ironsource/environment/token/TokenProvider;
...
.method public constructor <init>(Landroid/content/Context;Lcom/ironsource/sdk/service/TokenService;)V
    ...
    .line 34
    iput-object v0, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->SDK_ONE_TOKEN_FIELD:Ljava/lang/String;
    ...
    .line 43
    new-instance p1, Lcom/ironsource/sdk/service/NetworkGlobalDataWriter;

    invoke-direct {p1}, Lcom/ironsource/sdk/service/NetworkGlobalDataWriter;-><init>()V

    iput-object p1, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->mControllerGlobalDatarWriter:Lcom/ironsource/sdk/service/NetworkGlobalDataWriter;

    .line 44
    new-instance p1, Lcom/ironsource/environment/token/TokenProvider;

    invoke-direct {p1}, Lcom/ironsource/environment/token/TokenProvider;-><init>()V

    iput-object p1, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->mTokenProvider:Lcom/ironsource/environment/token/TokenProvider;
...
.method private getOneToken()Lorg/json/JSONObject;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/json/JSONException;
    ...
    .line 94
    iget-object v0, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->mTokenProvider:Lcom/ironsource/environment/token/TokenProvider;

    invoke-virtual {v0}, Lcom/ironsource/environment/token/TokenProvider;->getToken()Lorg/json/JSONObject;
...
.method private getRawToken(Lcom/ironsource/sdk/controller/TokenJSAdapter$FunctionCall;Lcom/ironsource/sdk/controller/WebController$NativeAPI$JSCallbackTask;)V
    ...
    .line 86
    invoke-direct {p0}, Lcom/ironsource/sdk/controller/TokenJSAdapter;->getOneToken()Lorg/json/JSONObject;
    ...
    :cond_0
    iget-object v0, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->mTokenService:Lcom/ironsource/sdk/service/TokenService;

    iget-object v1, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->mContext:Landroid/content/Context;

    invoke-virtual {v0, v1}, Lcom/ironsource/sdk/service/TokenService;->getRawToken(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    .line 87
    iget-object v2, p1, Lcom/ironsource/sdk/controller/TokenJSAdapter$FunctionCall;->successCallback:Ljava/lang/String;

    invoke-virtual {p2, v1, v2, v0}, Lcom/ironsource/sdk/controller/WebController$NativeAPI$JSCallbackTask;->sendMessage(ZLjava/lang/String;Lorg/json/JSONObject;)V
    :try_end_0
...
.method public updateToken(Lorg/json/JSONObject;Lcom/ironsource/sdk/controller/TokenJSAdapter$FunctionCall;Lcom/ironsource/sdk/controller/WebController$NativeAPI$JSCallbackTask;)V
    ...
    .line 73
    :try_start_0
    iget-object v1, p0, Lcom/ironsource/sdk/controller/TokenJSAdapter;->mControllerGlobalDatarWriter:Lcom/ironsource/sdk/service/NetworkGlobalDataWriter;

    invoke-virtual {v1, p1}, Lcom/ironsource/sdk/service/NetworkGlobalDataWriter;->extendData(Lorg/json/JSONObject;)V
