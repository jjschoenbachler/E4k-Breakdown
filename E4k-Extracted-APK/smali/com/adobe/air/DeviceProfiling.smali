...
.method public static checkAndInitiateProfiler(Landroid/app/Activity;)Z
    ...
    .line 52
    sget-object p0, Lcom/adobe/air/DeviceProfiling;->mResManager:Lcom/adobe/air/ResourceFileManager;

    sget-object v0, Lcom/adobe/air/DeviceProfiling;->mResManager:Lcom/adobe/air/ResourceFileManager;

    const-string v1, "raw.debugger"
    ...
    const-string v2, "raw.profileragent"
    ...
    const-string v3, "Preload SWF/debughost resource does not exist inside the APK"
    ...
    invoke-static {v1, p0}, Lcom/adobe/air/utils/AIRLogger;->d(Ljava/lang/String;Ljava/lang/String;)I
...
.method private static insertPreloadTagEntry()V
    ...
    invoke-virtual {v4, v5, v2}, Lcom/adobe/air/ResourceFileManager;->extractResource(ILjava/io/File;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v7, " Extracting Resource debugInfo failed "
    ...
    invoke-static {v5, v4}, Lcom/adobe/air/utils/AIRLogger;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v2, v5}, Lcom/adobe/air/utils/Utils;->parseKeyValuePairFile(Ljava/io/File;Ljava/lang/String;)Ljava/util/HashMap;
    ...
    const-string v7, " Parsing for key-value pairs failed/mm.cfg not found "
    ...
    invoke-static {v5, v2}, Lcom/adobe/air/utils/AIRLogger;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v6, "Reading from Configuration file with path"
    ...
    invoke-static {v3, v0}, Lcom/adobe/air/utils/AIRLogger;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :goto_3
    :try_start_3
    invoke-static {v4, v1}, Lcom/adobe/air/utils/Utils;->writeBufferToFile(Ljava/lang/StringBuffer;Ljava/io/File;)V
    :try_end_3
    ...
    const-string v3, " Writing string buffer to file failed "
...
.method private static insertTrustConfigEntry()V
    ...
    const-string v3, "Recursive Copy for FlashPlayerTrust folder failed."
    ...
    const-string v3, " Write to FlashPlayerTrust Failed"
