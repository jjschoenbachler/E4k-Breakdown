...
.method private initialize()V
    ...
    .line 79
    sget v0, Lcom/adobe/air/R$id;->wandView:I
...
.method private terminate()V
    ...
    .line 186
    iget-object v1, p0, Lcom/adobe/air/wand/WandActivity;->mWandWebSocket:Lcom/adobe/air/wand/connection/WandWebSocket;

    invoke-virtual {v1}, Lcom/adobe/air/wand/connection/WandWebSocket;->dispose()V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 69
    sget p1, Lcom/adobe/air/R$layout;->wand_main:I

    invoke-virtual {p0, p1}, Lcom/adobe/air/wand/WandActivity;->setContentView(I)V
...
.method public onPause()V
    ...
    .line 140
    iget-object v1, p0, Lcom/adobe/air/wand/WandActivity;->mWandManager:Lcom/adobe/air/wand/WandManager;

    invoke-virtual {v1, v0}, Lcom/adobe/air/wand/WandManager;->focus(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onWindowFocusChanged(Z)V
    ...
    iget-object p1, p0, Lcom/adobe/air/wand/WandActivity;->mWandManager:Lcom/adobe/air/wand/WandManager;

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/adobe/air/wand/WandActivity;->mWandManager:Lcom/adobe/air/wand/WandManager;

    invoke-virtual {p1}, Lcom/adobe/air/wand/WandManager;->hasFocus()Z
    ...
    invoke-virtual {p1, v0}, Lcom/adobe/air/wand/WandManager;->focus(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
