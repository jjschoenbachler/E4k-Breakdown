...
.method public constructor <init>(Lcom/adobe/air/wand/message/MessageManager;Landroid/view/Display;Lcom/adobe/air/wand/view/TouchSensor;Lcom/adobe/air/wand/motionsensor/Accelerometer;Lcom/adobe/air/wand/motionsensor/Magnetometer;Lcom/adobe/air/wand/motionsensor/Gyroscope;Landroid/os/Vibrator;)V
    ...
    .line 218
    iget-object p1, p0, Lcom/adobe/air/wand/TaskManager;->mTouchSensor:Lcom/adobe/air/wand/view/TouchSensor;

    new-instance p2, Lcom/adobe/air/wand/TaskManager$1;

    invoke-direct {p2, p0}, Lcom/adobe/air/wand/TaskManager$1;-><init>(Lcom/adobe/air/wand/TaskManager;)V

    invoke-virtual {p1, p2}, Lcom/adobe/air/wand/view/TouchSensor;->setListener(Lcom/adobe/air/wand/view/TouchSensor$Listener;)V

    .line 233
    iget-object p1, p0, Lcom/adobe/air/wand/TaskManager;->mAccelerometer:Lcom/adobe/air/wand/motionsensor/Accelerometer;

    new-instance p2, Lcom/adobe/air/wand/TaskManager$2;

    invoke-direct {p2, p0}, Lcom/adobe/air/wand/TaskManager$2;-><init>(Lcom/adobe/air/wand/TaskManager;)V

    invoke-virtual {p1, p2}, Lcom/adobe/air/wand/motionsensor/Accelerometer;->setListener(Lcom/adobe/air/wand/motionsensor/MotionSensor$Listener;)V

    .line 242
    iget-object p1, p0, Lcom/adobe/air/wand/TaskManager;->mMagnetometer:Lcom/adobe/air/wand/motionsensor/Magnetometer;

    new-instance p2, Lcom/adobe/air/wand/TaskManager$3;

    invoke-direct {p2, p0}, Lcom/adobe/air/wand/TaskManager$3;-><init>(Lcom/adobe/air/wand/TaskManager;)V

    invoke-virtual {p1, p2}, Lcom/adobe/air/wand/motionsensor/Magnetometer;->setListener(Lcom/adobe/air/wand/motionsensor/MotionSensor$Listener;)V

    .line 251
    iget-object p1, p0, Lcom/adobe/air/wand/TaskManager;->mGyroscope:Lcom/adobe/air/wand/motionsensor/Gyroscope;

    new-instance p2, Lcom/adobe/air/wand/TaskManager$4;

    invoke-direct {p2, p0}, Lcom/adobe/air/wand/TaskManager$4;-><init>(Lcom/adobe/air/wand/TaskManager;)V

    invoke-virtual {p1, p2}, Lcom/adobe/air/wand/motionsensor/Gyroscope;->setListener(Lcom/adobe/air/wand/motionsensor/MotionSensor$Listener;)V
    ...
    const-string p2, "Invalid TouchSensor"
    ...
    const-string p2, "Invalid Gyroscope"
    ...
    const-string p2, "Invalid Magnetometer"
    ...
    const-string p2, "Invalid Accelerometer"
    ...
    const-string p2, "Invalid MessageManager"
...
.method private handleDrawImageRequest(Lcom/adobe/air/wand/message/Request;)V
    ...
    invoke-interface {v0, p1}, Lcom/adobe/air/wand/TaskManager$Listener;->sendConnectionMessage(Ljava/lang/String;)V
    :try_end_1
    ...
    :catch_1
    const-string p1, "Invalid DRAW_IMAGE request"

    .line 911
    invoke-direct {p0, p1}, Lcom/adobe/air/wand/TaskManager;->sendLogNotification(Ljava/lang/String;)V
...
.method private handleHardwareSpecsRequest(Lcom/adobe/air/wand/message/Request;)V
    ...
    :catch_1
    const-string p1, "Invalid HARDWARE_SPECIFICATIONS request"
...
.method private handleRemoteAccelerometerEventNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    const-string p1, "The device does not have an accelerometer"
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/message/Notification$Data;->getNotification()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/adobe/air/wand/message/MessageDataObject;

    const-string v0, "start"

    .line 592
    invoke-interface {p1, v0}, Lcom/adobe/air/wand/message/MessageDataObject;->getBoolean(Ljava/lang/String;)Z
    ...
    .line 596
    invoke-interface {p1, v0}, Lcom/adobe/air/wand/message/MessageDataObject;->getInt(Ljava/lang/String;)I
    ...
    invoke-virtual {v0, p1}, Lcom/adobe/air/wand/motionsensor/Accelerometer;->start(I)V

    goto :goto_0

    :cond_2
    const-string p1, "Already started accelerometer event updates"
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/motionsensor/Accelerometer;->active()Z
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/motionsensor/Accelerometer;->stop()V

    goto :goto_0

    :cond_4
    const-string p1, "Already stopped accelerometer event updates"
    ...
    :catch_0
    const-string p1, "Invalid ACCELEROMETER_EVENT notification"
...
.method private handleRemoteGestureNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/view/TouchSensor;->activeGestureListening()Z
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/view/TouchSensor;->startGestureEventListening()V

    goto :goto_0

    :cond_0
    const-string p1, "Already started gesture event updates"
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/view/TouchSensor;->stopGestureEventListening()V

    goto :goto_0

    :cond_2
    const-string p1, "Already stopped gesture event updates"
    ...
    :catch_0
    const-string p1, "Invalid GESTURE_EVENT notification"
...
.method private handleRemoteGyroscopeEventNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    const-string p1, "The device does not have a gyroscope"
    ...
    invoke-virtual {v0, p1}, Lcom/adobe/air/wand/motionsensor/Gyroscope;->start(I)V

    goto :goto_0

    :cond_2
    const-string p1, "Already started gyroscope event updates"
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/motionsensor/Gyroscope;->active()Z
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/motionsensor/Gyroscope;->stop()V

    goto :goto_0

    :cond_4
    const-string p1, "Already stopped gyroscope event updates"
    ...
    :catch_0
    const-string p1, "Invalid GYROSCOPE_EVENT notification"
...
.method private handleRemoteMagnetometerEventNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    const-string p1, "The device does not have an magnetometer"
    ...
    invoke-virtual {v0, p1}, Lcom/adobe/air/wand/motionsensor/Magnetometer;->start(I)V

    goto :goto_0

    :cond_2
    const-string p1, "Already started magnetometer event updates"
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/motionsensor/Magnetometer;->active()Z
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/motionsensor/Magnetometer;->stop()V

    goto :goto_0

    :cond_4
    const-string p1, "Already stopped magnetometer event updates"
    ...
    :catch_0
    const-string p1, "Invalid MAGNETOMETER_EVENT notification"
...
.method private handleRemoteNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    const-string v1, "Unsupported NOTIFICATION title : "
...
.method private handleRemoteRequest(Lcom/adobe/air/wand/message/Request;)V
    ...
    const-string v1, "Unsupported REQUEST title : "
...
.method private handleRemoteResponse(Lcom/adobe/air/wand/message/Response;)V
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/message/Response$Header;->getTitle()Ljava/lang/String;
    ...
    const-string v1, "Unsupported RESPONSE title : "
...
.method private handleRemoteTouchNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/view/TouchSensor;->activeTouchListening()Z
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/view/TouchSensor;->startTouchEventListening()V

    goto :goto_0

    :cond_0
    const-string p1, "Already started touch event updates"
    ...
    invoke-virtual {p1}, Lcom/adobe/air/wand/view/TouchSensor;->stopTouchEventListening()V

    goto :goto_0

    :cond_2
    const-string p1, "Already stopped touch event updates"
    ...
    :catch_0
    const-string p1, "Invalid TOUCH_EVENT notification"
...
.method private handleRemoteVibrateNotification(Lcom/adobe/air/wand/message/Notification;)V
    ...
    .line 846
    invoke-interface {p1, v0}, Lcom/adobe/air/wand/message/MessageDataObject;->getLong(Ljava/lang/String;)J
    ...
    const-string p1, "Invalid vibrate duration."
    ...
    .line 856
    iget-object p1, p0, Lcom/adobe/air/wand/TaskManager;->mVibrator:Landroid/os/Vibrator;
    ...
    :cond_1
    const-string p1, "Device does not support vibration"
    ...
    :catch_0
    const-string p1, "Invalid VIBRATE notification"
...
.method private sendLogNotification(Ljava/lang/String;)V
    ...
    .line 447
    iget-object p1, p0, Lcom/adobe/air/wand/TaskManager;->mMessageManager:Lcom/adobe/air/wand/message/MessageManager;
    ...
    invoke-virtual {p1, v1, v0}, Lcom/adobe/air/wand/message/MessageManager;->createSerializedNotification(Ljava/lang/String;Lcom/adobe/air/wand/message/MessageDataObject;)Ljava/lang/String;
...
.method private sendMotionSensorData([FJLjava/lang/String;Lcom/adobe/air/wand/TaskManager$MessageTitle;)V
    ...
    invoke-interface {v3, v4, p2, p3}, Lcom/adobe/air/wand/message/MessageDataArray;->put(IJ)Lcom/adobe/air/wand/message/MessageDataArray;
    ...
    invoke-virtual {p1, p2, v0}, Lcom/adobe/air/wand/message/MessageManager;->createSerializedNotification(Ljava/lang/String;Lcom/adobe/air/wand/message/MessageDataObject;)Ljava/lang/String;

    move-result-object p1

    .line 416
    iget-object p2, p0, Lcom/adobe/air/wand/TaskManager;->mListener:Lcom/adobe/air/wand/TaskManager$Listener;

    if-eqz p2, :cond_1

    iget-object p2, p0, Lcom/adobe/air/wand/TaskManager;->mListener:Lcom/adobe/air/wand/TaskManager$Listener;

    invoke-interface {p2, p1}, Lcom/adobe/air/wand/TaskManager$Listener;->sendConnectionMessage(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
