...
.method public static final synthetic access$getExternalHashedUserData$p(Lcom/facebook/appevents/UserDataStore;)Ljava/util/concurrent/ConcurrentHashMap;
    .locals 2

    const-class p0, Lcom/facebook/appevents/UserDataStore;
...
.method public static final synthetic access$getInitialized$p(Lcom/facebook/appevents/UserDataStore;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 2
    ...
    :cond_0
    :try_start_0
    sget-object p0, Lcom/facebook/appevents/UserDataStore;->initialized:Ljava/util/concurrent/atomic/AtomicBoolean;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static final synthetic access$getInternalHashedUserData$p(Lcom/facebook/appevents/UserDataStore;)Ljava/util/concurrent/ConcurrentHashMap;
    .locals 2
...
.method public static final synthetic access$getSharedPreferences$p(Lcom/facebook/appevents/UserDataStore;)Landroid/content/SharedPreferences;
    .locals 2
    ...
    :cond_0
    :try_start_0
    sget-object p0, Lcom/facebook/appevents/UserDataStore;->sharedPreferences:Landroid/content/SharedPreferences;
...
.method public static final synthetic access$getTAG$p(Lcom/facebook/appevents/UserDataStore;)Ljava/lang/String;
    .locals 2
...
.method public static final synthetic access$initAndWait(Lcom/facebook/appevents/UserDataStore;)V
    .locals 1
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0}, Lcom/facebook/appevents/UserDataStore;->initAndWait()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static final synthetic access$setSharedPreferences$p(Lcom/facebook/appevents/UserDataStore;Landroid/content/SharedPreferences;)V
    .locals 0
    ...
    :cond_0
    :try_start_0
    sput-object p1, Lcom/facebook/appevents/UserDataStore;->sharedPreferences:Landroid/content/SharedPreferences;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static final synthetic access$updateHashUserData(Lcom/facebook/appevents/UserDataStore;Landroid/os/Bundle;)V
    .locals 1
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1}, Lcom/facebook/appevents/UserDataStore;->updateHashUserData(Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static final synthetic access$writeDataIntoCache(Lcom/facebook/appevents/UserDataStore;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/facebook/appevents/UserDataStore;->writeDataIntoCache(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static final clear()V
    ...
    sget-object v1, Lcom/facebook/appevents/UserDataStore$clear$1;->INSTANCE:Lcom/facebook/appevents/UserDataStore$clear$1;
...
.method private final declared-synchronized initAndWait()V
    ...
    :goto_0
    const-string v1, "sharedPreferences.getStr\u2026(USER_DATA_KEY, \"\") ?: \"\""
...
.method public static final setInternalUd(Ljava/util/Map;)V
    ...
    invoke-virtual {v7, v3, v5}, Lkotlin/text/Regex;->split(Ljava/lang/CharSequence;I)Ljava/util/List;
...
.method public static final setUserDataAndHash(Landroid/os/Bundle;)V
    ...
    new-instance v1, Lcom/facebook/appevents/UserDataStore$setUserDataAndHash$1;

    invoke-direct {v1, p0}, Lcom/facebook/appevents/UserDataStore$setUserDataAndHash$1;-><init>(Landroid/os/Bundle;)V
...
.method private final writeDataIntoCache(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/facebook/appevents/UserDataStore$writeDataIntoCache$1;

    invoke-direct {v1, p1, p2}, Lcom/facebook/appevents/UserDataStore$writeDataIntoCache$1;-><init>(Ljava/lang/String;Ljava/lang/String;)V
