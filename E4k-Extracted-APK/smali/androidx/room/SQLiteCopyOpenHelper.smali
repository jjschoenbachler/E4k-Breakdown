...
.method private verifyDatabaseFile()V
    ...
    .line 123
    :try_start_0
    invoke-virtual {v3}, Landroidx/room/util/CopyLock;->lock()V
    ...
    .line 128
    :try_start_1
    invoke-direct {p0, v1}, Landroidx/room/SQLiteCopyOpenHelper;->copyDatabaseFile(Ljava/io/File;)V
    :try_end_1
    ...
    .line 148
    :try_start_4
    iget v4, p0, Landroidx/room/SQLiteCopyOpenHelper;->mDatabaseVersion:I
    :try_end_4
    ...
    invoke-virtual {v4, v2, v5}, Landroidx/room/DatabaseConfiguration;->isMigrationRequired(II)Z
    ...
    const-string v4, "Failed to delete database file ("
